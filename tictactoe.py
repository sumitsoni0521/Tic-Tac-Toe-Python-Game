...
label = Label(top_frame, text=player + " Turn",
              font=('arial', 30), bg="#5D6D7E", fg="white")
label.place(x=440, y=200)

reset_button = Button(top_frame, text="Restart Game", font=(
    'arial', 30), bg="#5D6D7E", fg="white", command=new_game)
